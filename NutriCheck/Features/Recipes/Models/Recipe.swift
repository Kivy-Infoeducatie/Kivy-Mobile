...
let recipes: [Recipe] = [
    Recipe(
        ...
        recipeDescription: "Traditional Romanian stuffed cabbage rolls (Sarmale) made with sour cabbage leaves, filled with ground pork, rice, and aromatic herbs",
        ingredients: [
    ...
    Recipe(
        ...
        recipeDescription: "A festive version of Romanian cabbage rolls, perfect for holiday celebrations and family gatherings",
        ingredients: [
    ...
    Recipe(
        ...
        recipeDescription: "Traditional Romanian sweet bread filled with a rich walnut and cocoa mixture, perfect for holidays",
        ingredients: [
    ...
    Recipe(
        ...
        recipeDescription: "Classic Romanian grilled meat rolls made with a mix of beef, lamb, and pork, seasoned with garlic and spices",
        ingredients: [
    ...
    Recipe(
        ...
        recipeDescription: "Traditional Romanian vegetable spread made with roasted eggplants, peppers, and mushrooms",
        ingredients: [
    ...
    Recipe(
        ...
        recipeDescription: "Traditional Romanian memorial wheat berry pudding, decorated with ground nuts and cocoa",
        ingredients: [
